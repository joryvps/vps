...
def usage():
    ...
    print("+---------------+\033[0m")
    print("")
    print("\033[1;33m Nickname: JORY.JY\033[0m")
    print("\033[1;33m Youtube: MASDEANDROIDPRO-JORY\033[0m")
    print("\033[1;33m WHATSAPP: POR YOUTUBE\033[0m")
    print("\033[1;33m Facebook: JORY.JY")
    print("YURI VASQUEZ OSCCO")
